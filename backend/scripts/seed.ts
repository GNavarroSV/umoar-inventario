...
const menus: MenuSeed[] = [
  ...
  { name: 'cost-centers', label: 'Centros de costo', path: '/dashboard/cost-centers', icon: 'gear', order: 4 },
  { name: 'suppliers', label: 'Proveedores', path: '/dashboard/suppliers', icon: 'person', order: 5 },
  { name: 'categories', label: 'Categorías', path: '/dashboard/categories', icon: 'table', order: 6 },
  { name: 'people', label: 'Personas', path: '/dashboard/people', icon: 'person', order: 7 },
  { name: 'roles', label: 'Usuarios y roles', path: '/dashboard/roles', icon: 'person', order: 8 },
  { name: 'menus', label: 'Menús', path: '/dashboard/menus', icon: 'gear', order: 9 },
  { name: 'users', label: 'Usuarios', path: '/dashboard/users', icon: 'person', order: 10 },
];
